...
if(strpos($this->getLevel()->getFolderName(), "Spawn") !== false)
return true;
...
if($position === null) {
if(strpos($originLevel->getFolderName(), "Spawn") !== false) {
$level = Main::getDimensionBaseLevel($originLevel);
$x = $this->x * 8;
$z = $this->z * 8;
$y = $this->y;
}else {
$worldName = $originLevel->getFolderName()."Spawn";
...
if(strpos($currentLevel->getFolderName(), "Spawn") !== false) {
$level = Main::getDimensionBaseLevel($currentLevel);
$x = (int)ceil($this->x * 8);
$z = (int)ceil($this->z * 8);
//$y = $this->y;
}else {
$worldName = $currentLevel->getFolderName()."Spawn";
...
if(strpos($level->getFolderName(), "Spawn"))
